...
\begin{align}
\cos \theta &= \frac{\vec{d} \cdot \vec{e}}{|\vec{d}| |\vec{e}|} \nonumber \\
            &= \frac{(tf(t_{1},d) \cdot idf(t_{1}))(tf(t_{1},e) \cdot idf(t_{1})) + (tf(t_{1},d) \cdot idf(t_{2}))(tf(t_{2},e) \cdot idf(t_{2})) + (tf(t_{3},d) \cdot idf(t_{3}))(tf(t_{3},e) \cdot idf(t_{3})) + \ldots + (tf(t_{m},d) \cdot idf(t_{m}))(tf(t_{m},e) \cdot idf(t_{m}))}{\sqrt{(tf(t_{1},d) \cdot idf(t_{1}))^2 + (tf(t_{2},d) \cdot idf(t_{2}))^2 + (tf(t_{3},d) \cdot idf(t_{3}))^2 + \ldots + (tf(t_{m},d) \cdot idf(t_{m}))(tf(t_{m},e))^2}\sqrt{(tf(t_{1},e) \cdot idf(t_{1}))^2 + (tf(t_{2},e) \cdot idf(t_{2}))^2 + (tf(t_{3},e) \cdot idf(t_{3}))^2 + \ldots + (tf(t_{m},e) \cdot idf(t_{m}))(tf(t_{m},e))^2}} \nonumber
\end{align}
