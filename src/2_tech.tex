...
まずは重み$ W^{\prime} $で$ E $を偏微分し，$ W^{\prime} $を得る．
\begin{align}
\frac{\partial E}{\partial {v_{ij}}^{\prime}} = \sum_{C=1}^{C} \frac{\partial E}{\partial u_{c,i}} \frac{\partial u_{c,i}}{\partial {v_{ij}}^{\prime}} \label{eq:wprimeh}
\end{align}
