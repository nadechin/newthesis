...
\subsection{結果}
\label{eval:conc}
SSHの低対話型Honeypotの稼働期間は12/10から2/1(54日間)で，収集できたものとしてコネクション数，パターン数，コマンド数を以下の図\ref{fig:honeypotdata}に記す．

% -------------------
\vspace{5mm}
\newlength{\myheight}
\setlength{\myheight}{5mm}
\begin{table}[h]
 ...
 \centering
  \begin{tabular}{c||l|l}
   \hline
   検知数 & 純正のHoneypot & 修正済みのHoneypot \\
    & (リスク) & \\
   \hline \hline 
     \parbox[c][\myheight][c]{0cm}{} コネクション数  & 19829 & 27914 \\
     \hline
     \parbox[c][\myheight][c]{0cm}{} パターン数  & 53 & 91 \\
     \hline
     \parbox[c][\myheight][c]{0cm}{} コマンド数  & 470 & 841 \\
     \hline
  \end{tabular}
\end{table}
\vspace{5mm}
