...
NECの異常行動検出エンジンAccessTracer\cite{AccessTracer}において，ユーザーのUNIXコマンドの履歴をオンライン忘却型学習アルゴリズムによる行動モデルの学習によってユーザーの普段と違うコマンド履歴を検知することができる．本研究との差異は学習モデルの違いである．隠れ変数を$ Zn $とし，観測値を$ Yn $とすると，以下の図\ref{fig:hiddenmarkov}ののように示すことができる．
