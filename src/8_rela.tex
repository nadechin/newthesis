...
日本電気株式会社中央研究所の開発した異常行動検出エンジンAccessTracer\cite{AccessTracer}において，ユーザーのUNIXコマンドの履歴をオンライン忘却型学習アルゴリズムによる行動モデルの学習によってユーザーの普段と違うコマンド履歴を検知することができる．本研究との差異は学習モデルの違いである．
