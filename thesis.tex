...
pdftitle={Product infomation manage system on 3D printing by Blockchain},%
%%pdfsubject={},%
pdfauthor={Ryosuke Abe},%
pdfkeywords={1.Digital Fabrication, 2.Product Libility, 3.3D pritnt, 4.Blockchain}%
]{hyperref}
\usepackage{bookmark}
